...
/******/ 	var hotCurrentHash = "6acbc3ff1f6358b74f1e"; // eslint-disable-line no-unused-vars
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _environment = __webpack_require__(297);
	...
	var _level = __webpack_require__(299);
	...
	class GameState {
	  ...
	  init() {
	    ...
	    this.environment = this.addModule(new _environment2.default(this.game));
	    this.level = this.addModule(new _level2.default(this.game, 5));
	    //this.level = this.addModule(new TilemapExample(this.game, 5));
	    this.player = this.addModule(new _player2.default(this.game, this.level));
	  }
	
	  // Load images and sounds
	  preload() {
	    this.modules.forEach(module => {
	      if (module.preload !== undefined) module.preload();
	    });
	  ...
	  wrapWorld() {
	    ...
	    const slide_in_pixel = _level2.default.BLOCK_SIZE * slide_in_blocks;
	    ...
	    if (pbody.position.x > slide_in_pixel + _level2.default.BLOCK_SIZE * 5) {
	      console.log("Wrapped!");
	  ...
	  bindKeys() {
	    ...
	    this.game.input.keyboard.addKeyCapture([Phaser.Keyboard.LEFT, Phaser.Keyboard.RIGHT, Phaser.Keyboard.UP, Phaser.Keyboard.DOWN, Phaser.Keyboard.SPACEBAR, Phaser.Keyboard.SHIFT, Phaser.Keyboard.D, Phaser.Keyboard.P, Phaser.Keyboard.J, Phaser.Keyboard.R]);
	  }
	...
	var game = new Phaser.Game(_level2.default.BLOCK_SIZE * 35, _level2.default.BLOCK_SIZE * 13, Phaser.AUTO, 'game');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	class Runner {
	  ...
	  create(entities) {
	    ...
	    this.sprite = this.game.add.sprite(100, this.game.height - _level2.default.BLOCK_SIZE * 4, 'hero');
	  ...
	  do_auto_jump() {
	    var _level$toBlockCoords = this.level.toBlockCoords(this.sprite.body.position.x - .5 * _level2.default.BLOCK_SIZE, this.sprite.body.position.y),
	        _level$toBlockCoords2 = _slicedToArray(_level$toBlockCoords, 2);
	
	    let px = _level$toBlockCoords2[0],
	        py = _level$toBlockCoords2[1];
...
/***/ (function(module, exports) {
	...
	class Level {
	  ...
	  chunk_levelGround(x, y, w) {
	    ...
	    if (this_is_higher) {
	      this.verticle_line(chunk_blocks, last_y, y, x, 'stone_left_to_underground_1x1', 'underground_left_edge_1x1', 'ground_cliff_left_1x1');
	      ...
	      this.verticle_line(chunk_blocks, last_y, y, x, 'stone_right_to_underground_1x1', 'underground_right_edge_1x1', 'ground_cliff_right_1x1');
	      this.horizontal_line(chunk_blocks, x + 1, x + w, y, 'ground_middle_1x1');
	      this.fill(chunk_blocks, x, 0, x + w, y - 1, 'underground_1x1');
	    } else {
	      // level with the other block
	  ...
	  chunk_pit(x, y, w) {
	    ...
	    // left edge
	    );this.verticle_line(chunk_blocks, 0, last_y, x, 'underground_right_edge_1x1', 'underground_right_edge_1x1', 'ground_cliff_right_1x1'
	
	    // pit
	    // -- its just empty
	
	    // right edge
	    );this.verticle_line(chunk_blocks, 0, y, x + w - 1, 'underground_left_edge_1x1', 'underground_left_edge_1x1', 'ground_cliff_left_1x1');
	    this.verticle_line(chunk_blocks, 0, y, x + w, 'underground_1x1', 'underground_1x1', 'ground_middle_1x1');
