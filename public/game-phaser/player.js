class Runner {
  ...
  create() {
    ...
    this.runner = this.game.add.sprite(this.game.width/2, this.game.height - 64, 'environment', 'ground1');

    // Enable physics on the player
    this.game.physics.enable(this.runner, Phaser.Physics.ARCADE);
